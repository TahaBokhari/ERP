...
// * @author tahab
// */
public class storeEntryReport extends javax.swing.JFrame {
//
//    /**
...
//     */
    ...
    public storeEntryReport() throws SQLException {
...
//                }
                ...
                Logger.getLogger(storeEntryReport.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(storeEntryReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new storeEntryReport().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(storeEntryReport.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
